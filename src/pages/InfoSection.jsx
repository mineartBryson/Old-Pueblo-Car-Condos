    ...
    <section className="info">
      <div className="info__content">
        <div className="info__cards">
          <Card title="Secure, Private Ownership" description="Unlike rentals, car condos are **owned** like real estate, giving you full customization and investment potential."/>
